...
class TrainingConfig(TrainingArguments):
    ...
    seperate_save_model: Optional[bool] = False
    return_token_logit: Optional[bool] = False
...
class ModelConfig:
    ...
    loss_type: Literal["bt", "reg", "btt", "margin", "constant_margin", "scaled", "bt+ntp"] = "regular"
